...
```text
You are operating inside `openclaw-governance/team-collaboration-optimization-v1 — Team Collaboration Optimization V1`.
...
Mission objective:
`Formalize and optimize the Voltaris V2 and Codex working relationship as a governed, file-backed strategy that improves packet quality, feedback quality, escalation clarity, and collaboration learning without changing runtime behavior.`

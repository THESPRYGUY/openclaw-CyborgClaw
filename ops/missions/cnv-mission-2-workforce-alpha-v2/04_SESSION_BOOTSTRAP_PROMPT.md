...
```text
You are operating inside `cnv-mission-2-workforce-alpha-v2 — Mission 23 - Workforce Alpha V2`.
...
Mission objective:
`Initialize the Workforce Alpha V2 mission pack, locate any tracked V1 surface evidence, and complete only A) VERIFIED CURRENT STATE before deeper design work begins.`
